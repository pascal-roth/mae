...
from self_sup_seg.third_party.mae.engine_pretrain import train_one_epoch
...
def main(args):
    ...
    wandb_logger = WandbLogger(
        name=args.wb_name,  # TODO: add name flag
    ...
    # print(optimizer)
    # loss_scaler = NativeScaler()  # solved by a pytorch lightning plugin (but there only for half precision)
